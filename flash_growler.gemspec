...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "PostInstall.txt", "README.rdoc", "Rakefile", "flash_growler.gemspec", "lib/flash_growler.rb", "lib/flash_growler/view_helpers.rb", "rails_generators/flash_growler_assets/flash_growler_assets_generator.rb", "rails_generators/flash_growler_assets/templates/alert.png", "rails_generators/flash_growler_assets/templates/bg.png", "rails_generators/flash_growler_assets/templates/default.css", "rails_generators/flash_growler_assets/templates/error.png", "rails_generators/flash_growler_assets/templates/guilded.flash_growler.js", "rails_generators/flash_growler_assets/templates/info.png", "rails_generators/flash_growler_assets/templates/jquery-growler-0.1.js", "script/console", "script/destroy", "script/generate", "spec/flash_growler_spec.rb", "spec/spec.opts", "spec/spec_helper.rb", "tasks/rspec.rake"]
  s.has_rdoc = true
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<midas-guilded>, [">= 0.0.4"])
      s.add_development_dependency(%q<hoe>, [">= 1.8.0"])
    else
      s.add_dependency(%q<newgem>, [">= 1.2.3"])
      s.add_dependency(%q<midas-guilded>, [">= 0.0.4"])
